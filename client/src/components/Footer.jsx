      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            <div className="logo">🌿 Benaa For All</div>
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li><Link to="/projects">مشروعات الجمعية</Link></li>
          ...
          <div className="footer-col">
            <h4>تواصل معنا</h4>
            <ul>
              <li><a href="mailto:info@benaa.eg">info@benaa.eg</a></li>
        ...
        <div className="footer-bottom">
          <p>© {new Date().getFullYear()} Benaa For All Foundation — جمعية بناء للتنمية بالمنيا — جميع الحقوق محفوظة</p>
        </div>
      </div>
    </footer>
  );
